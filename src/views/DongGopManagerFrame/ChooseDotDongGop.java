...
import controllers.DongGopManagerController.ChooseDotDongGopController;
 ...
 * @author Admin
 */
public class ChooseDotDongGop extends javax.swing.JFrame {

    private DotDongGopBean dotdonggopBean;
    private DotDongGopBean dotdonggopBeanTemp;
    private JPanel parentJPanel;
    private JFrame parentJframe;
    private final ChooseDotDongGopController controller;
    /**
     * Creates new form ChooseDotDongGop
     */
    public ChooseDotDongGop(DotDongGopBean donggopBean, JPanel parentJPanel) {
        initComponents();
        this.dotdonggopBean = donggopBean;
        this.parentJPanel = parentJPanel;
        this.dotdonggopBeanTemp = new DotDongGopBean();
        controller = new ChooseDotDongGopController(this.dotdonggopBeanTemp, searchJtf, selectedJtf, tableJpn);
    ...
    public ChooseDotDongGop(DotDongGopBean donggopBean, JFrame parentJframe) {
        initComponents();
        this.dotdonggopBean = donggopBean;
    ...
    public void setDotthuphiBeanTemp(DotDongGopBean dotdonggopBeanTemp) {
        this.dotdonggopBeanTemp = dotdonggopBeanTemp;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(650, 382));
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        if (this.dotdonggopBeanTemp.getDotDongGop().getTenDotDongGop() == null) {
            Close();
        }
        this.dotdonggopBean = new DotDongGopBean(this.dotdonggopBeanTemp.getDotDongGop());
        if(this.dotdonggopBean.getDotDongGop().getTenDotDongGop() != null){
            DongGopPanel chonDotDongGop = (DongGopPanel)this.parentJPanel;
            chonDotDongGop.setDataDongGop(this.dotdonggopBean.getDotDongGop().getTenDotDongGop());
        }
        dispose();
